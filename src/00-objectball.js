...
function numPointsScored(playerInput) {
    ...
    for (const gameKey in game){
        ...
        for (const teamKey in teamObject){
            const playObject = teamObject[teamKey]
...
const allPlayers = () => {return Object.assign({}, homePlayers(), awayPlayers())}

const shoeSize = (playerName) => { return allPlayers()[playerName].shoe}
